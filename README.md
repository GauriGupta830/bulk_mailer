...
⚠️ Security Notes
.env and client_secrets.json are not included in this repo — never commit real credentials.
Rotate your Google OAuth client secret and SECRET_KEY immediately if they're ever accidentally exposed.
